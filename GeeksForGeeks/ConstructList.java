...
Given a list s that initially contains only a single value 0. There will be q queries
...
constructList() which takes an integer q the number of queries and queries[] a list of 
lists of length 2 denoting the queries as input parameters and returns the final constructed list.
...
public class ConstructList
{
	...
	public static void main(String[] args) {
		...
		for(int i:constructList(q,queries))
		    System.out.print(i+" ");
	}
}
