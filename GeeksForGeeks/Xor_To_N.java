...
You need to calculate the bitwise XOR of each element in the array with its corresponding
...
Now print the resultant array
Your Task:
Since this is a function problem, you don't need to take any input. Just complete 
the provided functions. In a new line, print the output.
...
public class Xor_To_N
{
	public static void main(String[] args) {
		...
		solution.xor1ToN(n,a);
		solution.printArr(n,a);
		solution.setToZero(n,a);
		solution.printArr(n,a);
	}
}
