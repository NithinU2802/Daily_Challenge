...
Your Task:
You are required to implement the function game_with_number(), which takes an array 
arr, representing values at each index, and the size of the array n. The function
should modify the elements of the same array arr[] in-place by replacing them with 
the values obtained by performing the bitwise OR operation on consecutive elements.
...
public class GameWithNumber
{
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<n;i++)
		    arr[i]=x.nextInt();
		for(int i:game_with_number(arr,n))
		    System.out.print(i+" ");
	}
}
