...
Given a non-negative integer S represented as a string, remove K digits from the
...
removeKdigits() which takes the string S and an integer K as input and returns the new
number which is the smallest possible.
