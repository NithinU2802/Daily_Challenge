...
{3}, {2, 4}, {3, 5, 7}, {1, 8}, {9}
Your Task:
You dont need to read input or print anything. Complete the function antiDiagonalPattern()
that takes matrix as input parameter and returns a list of integers in order of the values
visited in the anti-Diagonal pattern. 
...
public class AntiDiagonalPattern
{
	...
	public static void main(String[] args) {
	    ...
	    for(int i:antiDiagonalPattern(matrix))
	        System.out.print(i+" ");
	}
}
